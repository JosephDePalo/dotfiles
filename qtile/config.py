...
#  D E F A U L T
    ...
    Key([mod, "control", "shift"], "r", lazy.spawn("polybar -r example"), desc="Reload polybar"),
...
# C U S T O M
    ...
    Key([mod],"e", lazy.spawn("alacritty -e /bin/zsh -c 'source ~/.zshrc && ranger'"), desc='File Manager'),
    Key([mod], "s", lazy.spawn("flameshot gui"), desc='Screenshot'),
    Key([mod], "w", lazy.spawn("brave"), desc='Browser'),
]
